...
exports.register = function( schemaId, path ){
    ...
    if( _.isObject(schemaId) ){
        localSchema = localSchema = exports.env.createSchema( schemaId );
    } else {
        var data = _.isObject(path) ? path : require( path );
        localSchema = exports.env.createSchema( data, localSchema, schemaId );
    }
    return localSchema;
}
...
exports.validate = function( json, schemaUri ){
...
exports.properties = function(schemaUri){
    var schema = schemaEnv.findSchema(schemaUri);
    if( schema )
