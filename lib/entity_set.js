...
var EntitySet = Backbone.Model.extend({
    ...
    */
    registerComponentDef: function( component ){
        ...
        record = {iid:component.schemaIId, name:name, schemaHash:component.schemaHash, schemaId:component.schemaId };

        // this._componentDefByHash[ component.schemaHash ] = record;
        // this._componentDefs[ defId ] = record;

        // component.defId = defId;
        this.trigger( 'component:register', component.schemaIId, record.schemaId, record.schemaHash, record.name );
    ...
    unregisterComponentDef: function( component ){
        ...
        // this.trigger('component:unregister', record.iid, record.schemaId, record.schemaHash, record.name );
    ...
    */
    ...
    _executeCmdBuffer: function( cmdBuffer, options ){
        ...
        // log.debug('any help here ' + cmdBuffer.length );
    ...
    */
    addComponent: function(component, options){
        ...
        if( !entity ){
            ...
            // if( debug ){
            //     // printE( entity );
            //     log.debug('looking for component ' + component.schemaIId );
            //     printVar( entity.components );
            // }
...
function addCommand( cmdBuffer, type, arg/*entityId|component*/, options ){
    ...
    // log.debug('addCommand ' + JSON.stringify(entityId) );
