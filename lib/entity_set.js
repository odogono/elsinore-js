...
var EntitySet = exports.EntitySet = Backbone.Model.extend({
    ...
    _isComponentDefOfInterest: function( componentDef ){
        return this._componentDefIds.length == 0 ||
            _.contains( this._componentDefIds, componentDef.id );
    },


    _addComponent: function(component, entity, options){
        var self = this;
        if( !this._isComponentDefOfInterest(component) ){
    ...
    */
    ...
    setEntities: function( entityArray ){
        var self = this;
        _.each( entityArray, function(entity){

        });
        // log.debug('es setEntities: '); print_ins(arguments,2);
