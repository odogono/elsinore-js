...
var EntitySet = Backbone.Model.extend({
    ...
    addComponent: function(component, options){
        var self = this, entityId, entity, componentDef, componentArray;
        options || (options = {});
        ...
        var entity = this.addEntity( component.getEntityId() );
        ...
        if( !silent ){
            this.trigger('add:component', component, entity.id );
        }
    ...
    addEntity: function(entity, options){
        var entityId, existingEntity, silent;
    ...
    removeEntity: function(entity, options){
        ...
        this._entityIds = _.without( this._entityIds, entityId );
        if( !silent ){
