...
_.extend( CmdBuffer.prototype, SyncCmdBuffer.prototype, {
    ...
    */
    ...
    //     if( type == SyncCmdBuffer.CMD_ENTITY_ADD ){
    //         // this command should always be the first in the list - check 
    //         if( entityBuffer.length > 0 && entityBuffer[0][0] == SyncCmdBuffer.CMD_ENTITY_ADD )
    //             return;
    //         // add to top of list
    ...
    //         if( cmds[0][0] == SyncCmdBuffer.CMD_ENTITY_ADD )
    //             return entityId;
    //     }
...
// _.extend( CmdBuffer.prototype, SyncCmdBuffer.prototype, functions );
