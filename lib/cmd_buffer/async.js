    ...
    */
    ...
    execute: function( entitySet, options ){
        ...
        return _.keys(this.cmds).reduce( function(sequence, entityId){
            ...
            // log.debug('resolving entityId ' + entityId );
            // printIns( cmds, 1 );
            ...
            //     }
            //     return Entity.toEntity( entityId );
            // })
            return sequence.then( function(){
                // log.debug('uh... ' + JSON.stringify(entity) );
                ...
                cmds.forEach( function(cmd){
                    ...
                    switch( cmd[0] ){
                        ...
                        case SyncCmdBuffer.CMD_COMPONENT_ADD:
                            ...
                            // log.debug('>- com add with ' + entity.cid );
                            entity.addComponent( component );
                            
                            if( !addedEntities.get(entity.cid) ){
                        ...
                        case SyncCmdBuffer.CMD_COMPONENT_REMOVE:
                            ...
                            if( (!entitySet.allowEmptyEntities || removeEmptyEntity) && !entity.hasComponents() ){
                                // log.debug('yah ok remove ' + self.entitiesRemoved );
