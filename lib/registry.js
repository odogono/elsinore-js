...
_.extend(Registry.prototype, Backbone.Events, {
    ...
    initialize: function(options){
        ...
        this.systems = new Backbone.Collection();
        this.systems.comparator = function(system){
    ...
    */
    ...
    update: function( callback ){
        ...
        return Promise.all( 
            this.systems.models.map( function(system){
                return current = current.then(function() {
                    return system.update( dt, self.updateStartTime, now, updateOptions );
                });
            })).then( function( results ){
                self.trigger('system:update:finish', self );
            });
        
        /*
        async.eachSeries( this.systems.models, function(system, cb){
