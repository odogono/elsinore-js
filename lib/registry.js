...
//     }
    ...
    _.extend(Registry.prototype, Backbone.Events, {
        ...
        destroyEntity: function( entityId, callback ){
            ...
            var components = this.getEntityComponents( entityId );
        ...
        */
         ...
         * @return {[type]}              [description]
         */
        updateComponent: function( components, options, callback ){
            options = options || {};
            components = _.isArray(components) ? components : [components];

            return this.storage.updateComponent( components, options, callback );
        },
