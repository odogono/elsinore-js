...
_.extend(Registry.prototype, Backbone.Events, {
    ...
    createComponent: function( componentDef, data, options ){
        ...
        if( _.isArray(data) ){
            ...
            for( i=0,len=data.length;i<len;i++ ){
                result.push( _createComponent( schemaIId, name, schema, defaults, data[i], entityId, options ) );
            }
        ...
        return _createComponent( schemaIId, name, schema, defaults, data, entityId, options );
    },
    ...
    */
    ...
    /**
    *   Takes any number of component identifiers and returns an id for each one
    */
    componentToId: function( varargs ){

    },

    // createEntityFilter: function( ){
    ...
    */
    addProcessor: function( processorModel, entitySet, options ){
        ...
        entitySetProcessors = this._entitySetProcessors[ entitySet.id ] || new Backbone.Collection();
