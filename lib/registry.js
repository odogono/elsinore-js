...
(function(){
    ...
    _.extend(Registry.prototype, Backbone.Events, {
        ...
        */
        ...
        addSystem: function( systemModel, systemId ){
            var System = systemModel;
            systemModel = systemModel.Model || systemModel;
            systemId = systemId || System.id;

            var system = EntitySystem.create({id:systemId,Model:systemModel,registry:this});
            this._systems[ systemId ] = system;
            this.trigger('system:add', system, this );
            return system;
        },

        update: function(){
            var system;
            for( var sysId in this._systems ){
                system = this._systems[ sysId ];
                system.update();
            }
        }
    });
