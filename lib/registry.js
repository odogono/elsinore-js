...
_.extend(Registry.prototype, Backbone.Events, {
    ...
    */
    ...
    createComponent: function( componentDef, data, options ){
        ...
        if( !schema ){
            throw new Error('no schema found for component');
        }
        ...
        if( _.isArray(data) ){
            ...
            for( i=0,len=data.length;i<len;i++ ){
                result.push( _createComponent( schema, defaults, data[i], entityId, options ) );
            }

            return result;
        }

        return _createComponent( schema, defaults, data, entityId, options );
...
*/
function _createComponent( schema, defaults, data, entityId, options ){
    var component;
    var datum;
    ...
    component.schemaId = schema.uri;
    
    component.hash = schema.hash;
