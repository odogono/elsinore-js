    ...
    */
    ...
    registerComponent: function( data, options ){
        ...
        if( this._schemaRegistry.get(data.id) ){
            print_ins( _.keys(self._componentSchemaIds) );
    ...
    */
    ...
    createEntitySet: function( options ){
        ...
        if( include && include != 'all' ){
            options.include = this.getComponentDef(include);   
        }
        if( exclude && exclude != 'all' ){
            options.exclude = this.getComponentDef(exclude);   
        }
        if( optional && optional != 'all' ){
            options.optional = this.getComponentDef(optional);
        }
