...
_.extend(Registry.prototype, Backbone.Events, {
    ...
    */
     ...
     * @return {[type]}          [description]
     */
    hasEntity: function( entity, callback ){
        var entity = this.toEntity(entity);
        return this.storage.hasEntity( entity, callback );
    },
    ...
    */
    ...
    createComponent: function( componentDefId, options ){
        ...
        var components = componentDefId.map( function(id){
            ...
            if( !def ){
                throw new Error('could not find Component Def for ' + id );
            }
        ...
        return this.storage.saveComponents( components, options )
            .then( function(components){
                ...
                self.trigger('component:create', result );
                return result;
            });
    },
    ...
    */
    ...
    createEntitySet: function( options ){
        ...
        // convert each componentDef spec to an array of ComponentDef Ids
        if( options.include ){
            options.include = this.getComponentDef(options.include);   
        }
        if( options.exclude ){
            options.exclude = this.getComponentDef(options.exclude);   
        }
        if( options.optional ){
            options.optional = this.getComponentDef(options.optional);   
        }

        var result = this.storage.createEntitySet( options );
        return result;
    },
