...
(function(){
    ...
    _.extend(Registry.prototype, Backbone.Events, {
        ...
        initialise: function(options,callback){
            ...
            this.entitySet = odgn.entity.EntitySet.create( this, options );
         ...
         * @return {[type]}        [description]
         */
        getEntityComponent: function( entity, component ){
            entity = this.toEntity(entity);
            return this.entitySet.getComponent( component, entity );
        },
         ...
         * @return {[type]}                 [description]
         */
        toComponentDefs: function( componentDefs ){
            var self = this;
            if( !_.isArray(componentDefs) ){
                componentDefs = [ componentDefs ];
            }
            // log.debug('toComponentDefs ' + JSON.stringify(componentDefs) );
        ...
        */
        removeComponent: function( component, entity, callback ){
            ...
            var single = !_.isArray(component);
            var componentDefs = this.toComponentDefs( component );
