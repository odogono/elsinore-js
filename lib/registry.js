...
_.extend(Registry.prototype, Backbone.Events, {
    ...
    createEntity: function(options){
        ...
        return this.storage.createEntity( entity ).then( function(entity){
    ...
    registerComponent: function( data, options ){
        ...
        var componentDef = ComponentDef.create( data );
        ...
        return this.storage.registerComponent( componentDef, options )
            .then( function(componentDef){
                ...
                self.ComponentDef[ ComponentDef.nameFromSchema( componentDef.schema,'') ] = componentDef.id;
    ...
    createComponent: function( componentDefId, attrs, options ){
        ...
        if( !componentDef ){
            return Promise.reject(new Error('component def not found'));
        }
        ...
        if( !doSave ){
            this.trigger('component:create', component, this );
            return Promise.resolve( component );
        }

        return this.storage.saveComponent( component, options )
            .then( function(component){
                self.trigger('component:create', component, self );
                return component;
            });
    },
