...
_.extend(Registry.prototype, Backbone.Events, {
    ...
    */
    ...
    addComponent: function( componentDef, entity, options ){
        var self = this;
        options = _.extend({}, options, {entity:entity});
        
        return this.createComponent( componentDef, options )
            .then(function(components){
                return self.storage.retrieveEntity( entity );
            });

        // // resolve the componentDef into a component instance
        // // return this.createComponent( componentDef, null, options )
        // //     .then( function(component){
        //     // log.debug('adding components to ' + entity.id );
        //         return self.storage.addComponents( components, entity, options )
        //             .then( function(components){
