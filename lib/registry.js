...
(function(){
    ...
    _.extend(Registry.prototype, Backbone.Events, {
         ...
         * @return {[type]}            [description]
         */
        getEntity: function( entityId, options, callback ){
            var self = this;
            if( _.isFunction(options) ){
                callback = options;
                options = {};
        ...
        registerEntityTemplate: function( schema, callback ){
            ...
            if( this.storage.registerEntityTemplate ){
                return this.storage.registerEntityTemplate( schema, function(err,schema){
                    self.trigger('entity_template:register', schema, this );
        ...
        createEntityFromTemplate: function( schemaId, options, callback ){
            ...
            return async.waterfall([
                ...
                function(entityResult,cb){
                    ...
                    // async.eachSeries( componentSchemas, function(com,cbAdd){
                    //     self.addComponent( com, entity, cbAdd );
                    // },cb);
                }
            ], function(err){
        ...
        getComponentDef: function( defId,callback ){
            ...
            // ALTHOUGH : all useable component defs should be loaded into
            // memoryStorage at startup
            if( this.storage.getComponentDef ){
                return this.storage.getComponentDef( defId, function(err,def){
                    return callback(null,def);
                });
            }
         ...
         * @return {[type]}                 [description]
         */
        toComponentDefs: function( componentDefs, callback ){
            var self = this;
        ...
        addComponent: function( component, entity, callback ){
            ...
            return this.instantiateComponents( component, function(err,components){
                ...
                return async.mapSeries( components, function(component,cb){
                    ...
                    if( err ){ return callback(err); }
                    if( single )
                        return callback(null,entity,components[0]);
                    return callback(null,entity,components);
                });
            });
        },
        ...
        getEntitiesWithComponents: function( componentDefs, options, callback ){
            ...
            componentDefs = this.toComponentDefs( componentDefs );
        ...
        createEntitySet: function( components, options, callback ){
            var result = odgn.entity.EntitySet.create( this, options );
