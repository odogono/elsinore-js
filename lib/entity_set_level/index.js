...
var LevelEntitySet = EntitySet.extend({
    ...
    */
    getComponentDefByHash: function( hash ){
        return LU.get( 
            this._db, 
            null,
            [Constants.COMPONENT_DEF_HASH,hash].join(Constants.DELIMITER),
            null );
    },
    ...
    */
    getComponentDef: function( schemaId, cached ){
        if( cached ){
        ...
        return LU.get( 
            this._db, 
            null,
            [Constants.COMPONENT_DEF_URI,schemaId].join(Constants.DELIMITER),
            null );
    },
    ...
    */
    update: function( entitiesAdded, entitiesUpdated, entitiesRemoved, componentsAdded, componentsUpdated, componentsRemoved ){
        ...
        return self._entityId.getMultiple( newEntities.length )
    ...
    */
    _setEntityId: function( entity, entityId, options ){
        var self = this;
    ...
    */
    ...
    query: function( query, options ){
        ...
        var result = Query.execute( this, query, options );
