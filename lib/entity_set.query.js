...
function commandEquals( context, op1, op2 ){
    ...
    value1 = valueOf( context, op1, true );//executeCommand( context, op1 ) );
    // value2 = executeCommand( context, op2 );
    // if( context.debug ){ log.debug('  value2 ' + JSON.stringify(value2)); }    
...
function commandFilter( context, entitySet, filterFunction ){
    ...
    if( context.debug ){ log.debug('cmd filter result: ' + entities.length ); } 
