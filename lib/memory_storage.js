...
_.extend(MemoryStorage.prototype, Backbone.Events, {
    ...
    */
     ...
     * @return {[type]}             [description]
     */
    addComponents: function(components, entity, callback ){
        var self = this;
    ...
    */
    ...
    createEntitySet: function( options ){
        ...
        return new Promise( function(resolve, reject){
            ...
            // log.debug('EntitySet: ' + result.toString() );
            result.storage = self;
    ...
    */
    reloadEntitySet: function( entitySet, options ){
        ...
        return new Promise( function(resolve, reject){
            ...
            // throw new Error('entities should be added with all components to the entityset, otherwise the component mask will not work properly')
            for(i=0,len=self._entitySet.length;i<len;i++ ){
                entity = self._entitySet.entities[i];
                entitySet.addEntity( entity );
            }

            // TODO : replace this with adding entities
