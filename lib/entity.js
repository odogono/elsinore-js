 ...
 */
var Entity = exports.Model = Backbone.Model.extend({
    ...
    getComponent: function( component, callback ){
        return this.registry.getEntityComponent( this, component, callback );
    },
    ...
    parse: function(resp, options){
        if( resp.component_bf ){
            resp.component_bf = new BitArray(64, resp.coms);
        }
    },
...
exports.create = function(id, options){
    ...
    result.id = id;
    result.set('component_bf', new BitArray(64) );
    return result;
};
