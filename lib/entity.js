...
var Entity = Backbone.Model.extend({
    ...
    addComponent: function( component ){
        ...
        var componentDef = component.getComponentDef();
        ...
        this.components[ componentDef.id ] = component;
    ...
    hasComponent: function( componentDef ){
        var bf = this.getComponentBitfield();
        var componentDefId = componentDef;
        if( Component.isComponent(componentDef) ){
            componentDefId = componentDef.getComponentDef().id;
        }
