...
exports._registerEntityType = function( entityDef, options ){
    // var schema;
    // log.debug('calling base _registerEntityType');
    options = (options || {});
    ...
    // if no entityClass was defined, then supply a default
    if( !entityDef._entityClass ){
    ...
    // else {
    //     entityDef.create = function(attrs,options) {
    //         return exports.create( entityDef.type, attrs, options );
    //     }
    // }
...
exports.registerEntity = function( entityDef, entity, options ){
    ...
    if( entity ){
        ...
        if( !entity.create ){
            entity.create = entityDef.create;
        }
    }
    return entityDef;
};
