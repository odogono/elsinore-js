...
var Entity = Model.extend({
    ...
    addComponent: function( component, options ){
        ...
        this.components[ component.iid ] = component;
        this.getComponentBitfield().set( component.iid, true );
    },

    removeComponent: function( component ){
        delete this[ component.name ];
        delete this.components[ component.iid ];
        this.getComponentBitfield().set( component.iid, false );
    },
