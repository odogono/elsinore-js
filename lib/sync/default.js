...
var ModelSync = exports.ModelSync = function(options){
    log.debug('ModelSync created ');
    _.bindAll( this, 'sync' );
};

_.extend( ModelSync.prototype, {

    constructor: function(){
        log.debug('ModelSync constructor');
    },
...
ModelSync.extend = Backbone.Model.extend;

exports.create = function(options){
    options = options || {};
    var result = new ModelSync(options);
    return result;
};