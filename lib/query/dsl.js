...
// attr: function( componentId, attr ){
//     var context = readContext( this, false, true, true );
//     context.pushVal( [Q.ATTR, componentId, attr] );
//     return context;
// },
...
var QueryFunctions = {
    ...
    */
    ...
    selectById: function( entityIds ){
        ...
        // }
        // log.debug('selectById ' + Utils.stringify(entityIds) );
    ...
    */
    attr: function( attr ){
        ...
        // pop the last component filter command
        // op = context.opStack.pop();
        // val = context.valStack.pop();
