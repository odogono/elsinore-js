...
function selectEntity( stack:QueryStack, value:StackValue ): InstResult<QueryStack> {
 ...
 */
function selectEntitiesWithAll( stack:QueryStack, criteria:StackValue ): InstResult<QueryStack> {
    let value:StackValue;
